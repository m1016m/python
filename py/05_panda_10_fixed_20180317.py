...
for ticker in ['AAPL','IBM','MSFT','GOOG']: 
    all_data[ticker]=web.get_data_google(ticker,start='2010-01-01', end='2017-12-31')
...
#==================================================================
#修改google finance API:
#將...\Anaconda3\pkgs\pandas-datareader-0.5.0-py35_0\Lib\site-packages\pandas_datareader\google
#內的 daily.py及quotes.py 取代為修改(URL)的新檔. (...\data\daily.py, quotes.py)
