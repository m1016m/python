# -*- coding: utf-8 -*-
"""
tensorflow_001_a.py -- TensorFlow Core tutorial
...
print(session01.run(adder_node, feed_dict={a:3,b:4.5})) #7.5

print(session01.run(adder_node, feed_dict={a:[1,3], b:[2,4]})) #[ 3.  7.]
...
# feed_dict, x:[100.0]
print(session01.run(linear_model, feed_dict={x:[100.0]})) #[29.7]
# feed_dict, x:[1,2,3,4]
print(session01.run(linear_model,{x:[1,2,3,4]})) #[ 0.  0.30  0.60  0.90]
...
train_writer = tf.summary.FileWriter('log/area',session01.graph)
...
#執行 TensorBoard
# > activate tensorflow
# >(tensorflow)> tensorboard --logdir=C:\Users\III\log\area

# chrome  127.0.0.1:6006
