...
url='file:///E://worspace//python//py//20180318.html'
...
#檢視 DataFrame 'data', 目前是預設的index(0,1,2,...), 預設的column(0,1,2,...)
data

#----------------------------------------------------------------------------
#先設一個中途點,以DataFrame.to_csv() method
#將目前記憶體中的 DataFrame 'data' 存到現行目錄下(硬碟中)
#檔案命名為 'cpp_data_2018.csv', 檔案格式為 csv
data.to_csv('cpp_data_2018.csv')

#以後如果要使用,就可以直接用pd.read_csv()讀入
