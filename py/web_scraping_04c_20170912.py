...
#將DataFrame 寫至 'cpp_data_2017.csv'
data.to_csv('cpp_data_2017.csv')
data=pd.read_csv('cpp_data_2017.csv')
...
data=data.iloc[:,1:6]  #先裁1~5欄位(含日期)
...
data=data[pd.notnull(data[92])] #92有值
