...
tips[:6][['total_bill','tip']] #檢視index 前五列, column [['total_bill','tip']]
...
#對應SQL: 'SELECT AVG(tip_pct) FROM tips GROUP BY sex,smoker;'
...
#or
tips.groupby(['sex','smoker'])['tip'].agg([('最高小費','max'),('平均小費','mean')])
