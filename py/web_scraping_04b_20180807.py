...
#設定變數url指向字串物件 'https://new.cpc.com.tw/division/mb/oil-more4.aspx'
#url='https://new.cpc.com.tw/division/mb/oil-more4.aspx'
url='file:///E://jack//學務//教材計劃//python//py//20180807.html'
...
#寫至 'df3.csv' csv檔，後續使用
data.to_csv('data_2017.csv')
